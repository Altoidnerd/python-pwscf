...
## nice visualization of eta!
  ...
  plt.title("Asymmetry parameters in H-C bondlength constrained \np-Cl_2-benzene MD tempw={}K, dt={} a.u., nstep={}, T_avg={}K".format(tempw, dt, nefgstep,  get_mean(temperatures)))
