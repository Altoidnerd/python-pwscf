...
efg_inds = range(efg_step_0, efg_step_0 + len(Cl1)) [:-12]
...
aCl1 = np.array( [ np.abs(cq) for cq in Cl1 ][:-12] )
aCl12= np.array( [ np.abs(cq) for cq in Cl12][:-12] )
aCl18= np.array( [ np.abs(cq) for cq in Cl18][:-12] )
aCl24= np.array( [ np.abs(cq) for cq in Cl24][:-12] )
