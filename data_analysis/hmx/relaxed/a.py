...
def main():
  ...
  plt.scatter(temperatures, cq_axial,      marker='x', color='k', s=50, label='expt\'l, axial')
  plt.scatter(temperatures, cq_equitorial, marker='x', color='b', s=50, label='expt\'l, equit.')
  plt.scatter(gipawtemps, gc0_axial,     marker="o", color='k', s=100, label='calc\'d, axial') 
  #plt.scatter(gipawtemps, gc_full_axial,     marker="s", color='g', s=60, label='GIPAW Cq, axial sites, corr_full') 
  plt.scatter(gipawtemps, gc0_equitorial,     marker="o", color='b', s=100, label='calc\'d, equit.') 
