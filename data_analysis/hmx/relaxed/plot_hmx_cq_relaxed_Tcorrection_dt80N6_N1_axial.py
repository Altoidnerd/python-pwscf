...
Tcorr0                = [.99501 ,.99186, .99197, .99066, .98938, .98843, .98712, .98704 ]
Tcorr_full            = [.99491 ,.99191, .99249, .99074, .98390, .98884, .98756, .98672 ]

gipaw_Vcorr_Tcorr0_cq_axial     =  [ gipaw_cq_axial[i]*Tcorr0[i] for i in range(8) ]
gipaw_Vcorr_Tcorr_full_cq_axial =  [ gipaw_cq_axial[i]*Tcorr_full[i] for i in range(8) ]


gc0=gipaw_Vcorr_Tcorr0_cq_axial 
gc_full=gipaw_Vcorr_Tcorr_full_cq_axial
...
def main():
  ...
  plt.scatter(gipawtemps, gc0,     marker="s", color='g', s=60, label='GIPAW Cq, axial sites, corr0') 
