...
#51 53  54  56
  ...
  r = get_rolling_avgs
  plt.scatter(efg_inds,  r(nqrfreqs1), color='r', label='N1  ', marker='.' )
  plt.scatter(efg_inds,  r(nqrfreqs3), color='g', label='N12 ', marker='.' )
  plt.scatter(efg_inds,  r(nqrfreqs4), color='b', label='N18 ', marker='.' )
  plt.scatter(efg_inds,  r(nqrfreqs6), color='m', label='N24 ', marker='.' )

  plt.scatter(efg_inds, r(nqrfreqs23), color='m', label='N1  ', marker=',' )
  plt.scatter(efg_inds, r(nqrfreqs25), color='y', label='N12 ', marker=',' )
  plt.scatter(efg_inds, r(nqrfreqs26), color='k', label='N18 ', marker=',' )
  plt.scatter(efg_inds, r(nqrfreqs28), color='r', label='N24 ', marker=',' )

  plt.scatter(efg_inds, r(nqrfreqs37), color='g', label='N1  ', marker='o' )
  plt.scatter(efg_inds, r(nqrfreqs39), color='b', label='N12 ', marker='o' )
  plt.scatter(efg_inds, r(nqrfreqs40), color='c', label='N18 ', marker='o' )
  plt.scatter(efg_inds, r(nqrfreqs42), color='m', label='N24 ', marker='o' )

  plt.scatter(efg_inds, r(nqrfreqs51), color='y', label='N1  ', marker='^' )
  plt.scatter(efg_inds, r(nqrfreqs53), color='k', label='N12 ', marker='^' )
  plt.scatter(efg_inds, r(nqrfreqs54), color='r', label='N18 ', marker='^' )
  plt.scatter(efg_inds, r(nqrfreqs56), color='b', label='N24 ', marker='^' )
