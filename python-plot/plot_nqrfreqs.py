...
nqrfreqs1  = [ f32(cq,eta) for (cq,eta) in zip(aCl1 , aeta1 ) ] 
nqrfreqs12 = [ f32(cq,eta) for (cq,eta) in zip(aCl12, aeta12) ] 
nqrfreqs18 = [ f32(cq,eta) for (cq,eta) in zip(aCl18, aeta18) ] 
nqrfreqs24 = [ f32(cq,eta) for (cq,eta) in zip(aCl24, aeta24) ] 
...
## nice visualization of eta!
  plt.scatter(efg_inds, nqrfreqs1 , color='r', label='Cl1 (MHz)', marker='.',s=5 )
  plt.scatter(efg_inds, nqrfreqs12, color='g', label='Cl12 (MHz)', marker=',',s=5 )
  plt.scatter(efg_inds, nqrfreqs18, color='b', label='Cl18 (MHz)', marker='>',s=5 )
  plt.scatter(efg_inds, nqrfreqs24, color='m', label='Cl24 (MHz)', marker='<',s=5 )
  ...
  #plt.ylim(ymin=-547.5)
  plt.savefig("nqr-freqs-dt{}-nstep{}-nefgstep{}-nosym-ecut100.pdf".format(dt, nstep, nefgstep))
