...
def main():
  ...
  plt.scatter(efg_inds, get_rolling_avgs(aCl1) , color='r', label='Cl1  (MHz)', marker='.' )
  #plt.plot(   efg_inds, aCl12, color='g',                     linewidth=1)
  plt.scatter(efg_inds, get_rolling_avgs(aCl12), color='g', label='Cl12 (MHz)', marker='.' ) 
  #plt.plot(   efg_inds, aCl18, color='b',                     linewidth=1)
  plt.scatter(efg_inds, get_rolling_avgs(aCl18), color='b', label='Cl18 (MHz)', marker=',' )
  #plt.plot(   efg_inds, aCl24, color='m',                     linewidth=1)
  plt.scatter(efg_inds, get_rolling_avgs(aCl24), color='m', label='Cl24 (MHz)', marker=',' )
