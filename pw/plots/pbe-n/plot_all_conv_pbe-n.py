...
plt.scatter(ecut, Cqs_pbe_nl, color='b', marker='s', label='GGA: Cl.pbe-nl-kjpaw_psl.1.0.0.UPF')
plt.scatter(ecut, Cqs_pbe_n, color='g', marker='o', label='LDA: Cl.pbe-n-kjpaw_psl.1.0.0.UPF')
