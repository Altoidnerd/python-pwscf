...
# ~/paradichlorobenzene/1_ecut_conv-nl-psl_1.0.0  >     grep Cq *| grep  'Cl  12'
#
...
plt.scatter(ecut, Cqs_pbe_nl, color='b', marker='s', label='Cl.pbe-nl-kjpaw_psl.1.0.0.UPF')
#plt.plot(ecut, etas)
plt.title("Cq for Cl12 in gamma-paradichlorobenzene vs. cutoff energy\npseudo=Cl.pbe-nl-kjpaw_psl-1.0.0.UPF")
plt.ylabel("Cq (MHz)")
