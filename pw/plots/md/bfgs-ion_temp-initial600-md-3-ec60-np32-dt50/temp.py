...
def main():
  ...
  #plt.plot(inds, diff_Etots, color='m', label='E_total[t] - E_total[0] = E_total[t] + 548.00599230 Ry')
  #plt.plot(inds, temperatures, color='c', label='cell temperature (K)')
  plt.plot(inds, normtemps, color='m', label='scaled cell temperature (K)\ntemperature[i]/{}K'.format(temperatures[0]))
