...
#plt.scatter(angles, cqs_xcis, color='r', label='in-plane, boat-mode ("x-cis")', marker='^',s=9 )
plt.scatter(sangles, cqs_xhet, color='b', label='in-plane, chair-mode', marker='s',s=20 )
plt.scatter(sangles, cqs_yhet, color='g', label='out-of plane, chair-mode', marker=',',s=20 )
#plt.scatter(angles, cqs_ycis, color='k', label='out-of plane, boat-mode ("y-cis")', marker='s',s=9 )
