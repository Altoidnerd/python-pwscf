...
plt.scatter(angles, etas_xcis, color='r', label='in-plane, boat-mode ("x-cis")', marker='^',s=9 )
plt.scatter(angles, etas_xhet, color='b', label='in-plane, chair-mode ("x-het")', marker='s',s=9 )
plt.scatter(angles, etas_yhet, color='g', label='out-of plane, chair-mode ("y-het")', marker='s',s=9 )
plt.scatter(angles, etas_ycis, color='k', label='out-of plane, boat-mode ("y-cis")', marker='s',s=9 )
