...
plt.scatter(angles, etas_xcis, color='r', label='in-plane, boat-mode', marker='^',s=20 )
plt.scatter(angles, etas_xhet, color='b', label='in-plane, chair-mode', marker=',',s=20 )
plt.scatter(angles, etas_yhet, color='g', label='out-of plane, chair-mode ',        marker='s',s=20 )
plt.scatter(angles, etas_ycis, color='k', label='out-of plane, boat-mode  ',        marker='o',s=20 )
...
plt.xlabel("theta_x, theta_y (deg)")
