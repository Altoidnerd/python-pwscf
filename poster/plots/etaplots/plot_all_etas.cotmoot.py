...
plt.scatter(cotmoot, etas_xcis, color='r', label='in-plane, boat-mode (asymmetric)', marker='^',s=20 )
plt.scatter(cotmoot, etas_xhet, color='b', label='in-plane, chair-mode (symmetric)', marker=',',s=20 )
plt.scatter(cotmoot, etas_yhet, color='g', label='out-of plane, chair-mode ',        marker='s',s=20 )
plt.scatter(cotmoot, etas_ycis, color='k', label='out-of plane, boat-mode  ',        marker='o',s=20 )
