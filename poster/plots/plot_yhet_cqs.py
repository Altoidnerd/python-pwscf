...
plt.scatter(angles, cqs_yhet, color='g', label='out-of plane, chair-mode', marker='s',s=9 )
#plt.scatter(angles, cqs_xcis, color='k', label='out-of plane, boat-mode', marker='s',s=9 )
