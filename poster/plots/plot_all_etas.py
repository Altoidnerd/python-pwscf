...
plt.scatter(angles, etas_xcis, color='r', label='in-plane, boat-mode (asymmetric)', marker='^',s=20 )
plt.scatter(angles, etas_xhet, color='b', label='in-plane, chair-mode (symmetric)', marker=',',s=20 )
